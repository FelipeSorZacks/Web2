...
// Función para eliminar producto (administrador)
...
function menuAdministrador() {
    let opcion;
    while (opcion !== "5") {
        opcion = prompt(`--- MENÚ ADMINISTRADOR ---
...
// Función principal para determinar tipo de usuario
function iniciarSistema() {
    console.log("¡Bienvenido al sistema de tienda!");
    let tipoUsuario;
    while (tipoUsuario !== "3") {
